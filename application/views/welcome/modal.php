...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="container modal-content">
    ...
    <div class="modal-dialog"></div>
      <div class="">
        <div class="row pb-5" style="margin-top: -38px;">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 85vh; width: 80vh;" src="assets/img/upload/tol1.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 85vh; width: 80vh;" src="assets/img/upload/tol2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 85vh; width: 80vh;" src="assets/img/upload/tol3.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 85vh; width: 80vh;" src="assets/img/upload/tol4.jpg" alt="Four slide">
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="row">
              <div class="col text-left"><b>Pak Budi</b></div>
              <div class="col text-right">
                <div class="dropdown">
                <div class="btn" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="fas fa-ellipsis-h"></i>
                </div>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="#"><i class="fas fa-pencil-alt pr-2"></i>Edit</a>
                  <a class="dropdown-item" href="#"><i class="fas fa-trash pr-2"></i>Hapus</a>
                </div>
              </div>
              </div>
            </div>
            <div class="row text-warning pb-5 px-3">Jalan Tol</div>
            <div class="row px-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol2.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol1.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol3.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol4.jpg" alt="Four slide">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol3.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol1.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol4.jpg" alt="Four slide">
                </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol4.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol2.jpg" alt="Second slide">
                </div>
                ...
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/tol1.jpg" alt="Four slide">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators4" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem1.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem3.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem4.jpg" alt="Four slide">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators5" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem2.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem1.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem3.jpg" alt="Third slide">
                </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators6" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem3.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem1.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem4.jpg" alt="Four slide">
                </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators7" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem4.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem2.jpg" alt="Second slide">
                </div>
                ...
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/jem1.jpg" alt="Four slide">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators8" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under1.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under3.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under4.jpg" alt="Four slide">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators9" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under2.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under1.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under3.jpg" alt="Third slide">
                </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators10" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under3.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under1.jpg" alt="Third slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under4.jpg" alt="Four slide">
                </div>
        ...
        <div class="row pb-5" style="margin-top: -38px;">
          <div class="col" style="border-right: solid #F1F1F1 2px;">
            <div id="carouselExampleIndicators11" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner text-center">
                <div class="carousel-item active">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under4.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under2.jpg" alt="Second slide">
                </div>
                ...
                <div class="carousel-item">
                  <img style="height: 80vh; width: 75vh;" src="assets/img/upload/under1.jpg" alt="Four slide">
                </div>
              </div>
            </div>
          </div>
